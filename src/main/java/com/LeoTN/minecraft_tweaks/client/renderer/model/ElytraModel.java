package com.LeoTN.minecraft_tweaks.client.renderer.model;
...
public class ElytraModel<T extends LivingEntity> extends AnimalModel<T> {
    private final ModelPart wing;
    private final boolean is_right_wing;

    public ElytraModel(ModelPart root, boolean is_right_wing) {
        if (is_right_wing) {
